...
var stopwatchClock = $(".container-stopwatch.stopwatch").find(".clock"),
...
function pauseStopwatch(){
    ...
    if(Number(localStorage.stopwatchBeginingTimestamp)){
        ...
        console.log(localStorage.stopwatchRunningTime);
        returnElapsedTime(localStorage.stopwatchRunningTime);
    }
}
...
if(seconds>30)
    ...
    var finalTime = (hours*60) + ":" + minutes ;
